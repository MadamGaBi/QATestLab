package myprojects.automation.assignment.utils.logging;
...
public class EventHandler implements WebDriverEventListener {
    ...
    public void beforeAlertAccept(WebDriver webDriver) {
        CustomReporter.log("Accept alert");
    }

    @Override
    public void afterAlertAccept(WebDriver webDriver) {
        CustomReporter.log("Alert is accepted successfully");
    }

    @Override
    public void afterAlertDismiss(WebDriver webDriver) {
        CustomReporter.log("Dismiss alert");
    }

    @Override
    public void beforeAlertDismiss(WebDriver webDriver) {
        CustomReporter.log("Alert is dismissed successfully");
    }
    ...
    public void afterNavigateTo(String url, WebDriver driver) {
        CustomReporter.log("Current URL: " + url);
    }
